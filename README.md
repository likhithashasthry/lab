...
git add . : this is used to all the changes made into the remote repository. <br> <br>
git commit -m"<message>" : name the changes and to stage it. <br> <br>
git checkout <branch1> : switching back into the branch. <br> <br>
